...
public class SpiralChimalliShield {
    ...
    public SpiralChimalliShield(Main plugin) {
        main = plugin;
    }

    public ItemStack getItemStack(int amount) {
        return main.itemstacks.createItemStack(amount, SHIELD, "Spiral Chimalli Shield", "A primitive, but decorated shield.");
    }

    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_1");
        ...
        recipe1.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        recipe1.setIngredient('B', new RecipeChoice.ExactChoice(new ItemStack(OAK_PLANKS)));
        Bukkit.addRecipe(recipe1);
        NamespacedKey key2 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_2");
        ...
        recipe2.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe2);
        NamespacedKey key3 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_3");
        ...
        recipe3.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe3);
        NamespacedKey key4 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_4");
        ...
        recipe4.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe4);
        NamespacedKey key5 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_5");
        ...
        recipe5.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe5);
        NamespacedKey key6 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_6");
        ...
        recipe6.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe6);
        NamespacedKey key7 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_7");
        ...
        recipe7.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));
        Bukkit.addRecipe(recipe7);
        NamespacedKey key8 = new NamespacedKey(main, "conquest_recipes_spiral_chimalli_shield_8");
        ...
        recipe8.setIngredient('F', new RecipeChoice.ExactChoice(new ItemStack(RED_DYE)));

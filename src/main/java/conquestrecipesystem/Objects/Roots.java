...
public class Roots {
    ...
    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(main, "conquest_recipes_roots_1");
        ...
        NamespacedKey key2 = new NamespacedKey(main, "conquest_recipes_roots_2");
        ...
        NamespacedKey key3 = new NamespacedKey(main, "conquest_recipes_roots_3");
        ...
        NamespacedKey key4 = new NamespacedKey(main, "conquest_recipes_roots_4");
        ...
        NamespacedKey key5 = new NamespacedKey(main, "conquest_recipes_roots_5");
        ...
        NamespacedKey key6 = new NamespacedKey(main, "conquest_recipes_roots_6");

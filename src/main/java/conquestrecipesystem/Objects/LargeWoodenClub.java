...
public class LargeWoodenClub {
    ...
    public ItemStack getItemStack(int amount) {
        return main.itemstacks.createItemStack(amount, WOODEN_SWORD, "Large Wooden Club", "A large wooden club fashioned out of stripped logs.");
    }
    ...
    public void registerRecipe() {
        ...
        NamespacedKey key3 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_3");
        ShapedRecipe recipe3 = new ShapedRecipe(key3, getItemStack(1));
        recipe3.shape("0I0", "0I0", "0S0");
        recipe3.setIngredient('I', STRIPPED_SPRUCE_LOG);
        recipe3.setIngredient('S', STICK);
        Bukkit.addRecipe(recipe3);
        NamespacedKey key4 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_4");
        ShapedRecipe recipe4 = new ShapedRecipe(key4, getItemStack(1));
        recipe4.shape("0I0", "0I0", "0S0");
        recipe4.setIngredient('I', STRIPPED_JUNGLE_LOG);
        recipe4.setIngredient('S', STICK);
        Bukkit.addRecipe(recipe4);
        NamespacedKey key5 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_5");
        ShapedRecipe recipe5 = new ShapedRecipe(key5, getItemStack(1));
        recipe5.shape("0I0", "0I0", "0S0");
        recipe5.setIngredient('I', STRIPPED_ACACIA_LOG);
        recipe5.setIngredient('S', STICK);
        Bukkit.addRecipe(recipe5);
        NamespacedKey key6 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_6");
        ShapedRecipe recipe6 = new ShapedRecipe(key6, getItemStack(1));
        recipe6.shape("0I0", "0I0", "0S0");
        recipe6.setIngredient('I', STRIPPED_DARK_OAK_LOG);
        recipe6.setIngredient('S', STICK);
        Bukkit.addRecipe(recipe6);
        NamespacedKey key7 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_7");
        ShapedRecipe recipe7 = new ShapedRecipe(key7, getItemStack(1));
        recipe7.shape("0I0", "0I0", "0S0");
        recipe7.setIngredient('I', STRIPPED_CRIMSON_STEM);
        recipe7.setIngredient('S', STICK);
        Bukkit.addRecipe(recipe7);
        NamespacedKey key8 = new NamespacedKey(main, "conquest_recipes_large_wooden_club_8");
        ShapedRecipe recipe8 = new ShapedRecipe(key8, getItemStack(1));
        recipe8.shape("0I0", "0I0", "0S0");
        recipe8.setIngredient('I', STRIPPED_WARPED_STEM);
        recipe8.setIngredient('S', STICK);

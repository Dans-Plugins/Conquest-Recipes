...
public class PrimitiveFishingSpear {
    ...
    public void registerRecipe() {
        ...
        recipe1.setIngredient('T', STRING);
        ...
        recipe2.setIngredient('T', STRING);
        ...
        recipe3.setIngredient('T', STRING);
        ...
        recipe4.setIngredient('T', STRING);
        ...
        recipe5.setIngredient('T', STRING);
        ...
        recipe6.setIngredient('T', STRING);

...
public class DecoratedChimalliShield {
    ...
    public DecoratedChimalliShield(Main plugin) {
        main = plugin;
    }

    public ItemStack getItemStack(int amount) {
        return main.itemstacks.createItemStack(amount, SHIELD, "Decorated Chimalli Shield", "A primitive, but decorated shield.");
    }

    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_1");
        ...
        NamespacedKey key2 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_2");
        ...
        NamespacedKey key3 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_3");
        ...
        NamespacedKey key4 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_4");
        ...
        NamespacedKey key5 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_5");
        ...
        NamespacedKey key6 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_6");
        ...
        NamespacedKey key7 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_7");
        ...
        NamespacedKey key8 = new NamespacedKey(main, "conquest_recipes_decorated_chimalli_shield_8");

...
public class SmallWoodenClub {
    ...
    public SmallWoodenClub(Main plugin) {
        main = plugin;
    }
    ...
    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_1");
        ...
        NamespacedKey key2 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_2");
        ...
        NamespacedKey key3 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_3");
        ...
        NamespacedKey key4 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_4");
        ...
        NamespacedKey key5 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_5");
        ...
        NamespacedKey key6 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_6");
        ...
        NamespacedKey key7 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_7");
        ...
        NamespacedKey key8 = new NamespacedKey(main, "conquest_recipes_small_wooden_club_8");

...
public class RootmossClothShoes {
    ...
    public ItemStack getItemStack(int amount) {
        return conquestRecipes.itemstacks.createItemStack(amount, CHAINMAIL_BOOTS, "Rootmoss Cloth Shoes", "A rootmoss pair of shoes. Made of intertwined vines and roots.");
    }

...
public class BronzeGladiatorHelmet {
    ...
    public ItemStack getItemStack(int amount) {
        return conquestRecipes.itemstacks.createItemStack(amount, CARVED_PUMPKIN, "Bronze Gladiator Helmet", "A bronze helmet, meant to be worn by those of the gladiatorial pits.");
    }

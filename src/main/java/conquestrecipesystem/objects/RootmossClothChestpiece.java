...
public class RootmossClothChestpiece {
    ...
    public ItemStack getItemStack(int amount) {
        return conquestRecipes.itemstacks.createItemStack(amount, CHAINMAIL_CHESTPLATE, "Rootmoss Cloth Chestpiece", "A rootmoss chestpiece. Made of intertwined vines and roots.");
    }

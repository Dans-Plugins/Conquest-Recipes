...
public class LargeWoodenClub {
    ...
    public LargeWoodenClub(ConquestRecipes plugin) {
        conquestRecipes = plugin;
    }

    public ItemStack getItemStack(int amount) {
        return conquestRecipes.getItemStackService().createItemStack(amount, WOODEN_SWORD, "Large Wooden Club", "A large wooden club fashioned out of stripped logs.");
    }

    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_1");
        ...
        NamespacedKey key2 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_2");
        ...
        NamespacedKey key3 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_3");
        ...
        NamespacedKey key4 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_4");
        ...
        NamespacedKey key5 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_5");
        ...
        NamespacedKey key6 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_6");
        ...
        NamespacedKey key7 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_7");
        ...
        NamespacedKey key8 = new NamespacedKey(conquestRecipes, "conquest_recipes_large_wooden_club_8");

...
public class SpiralChimalliShield {
    ...
    public SpiralChimalliShield(ConquestRecipes plugin) {
    ...
    public void registerRecipe() {
        NamespacedKey key1 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_1");
        ...
        NamespacedKey key2 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_2");
        ...
        NamespacedKey key3 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_3");
        ...
        NamespacedKey key4 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_4");
        ...
        NamespacedKey key5 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_5");
        ...
        NamespacedKey key6 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_6");
        ...
        NamespacedKey key7 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_7");
        ...
        NamespacedKey key8 = new NamespacedKey(conquestRecipes, "conquest_recipes_spiral_chimalli_shield_8");

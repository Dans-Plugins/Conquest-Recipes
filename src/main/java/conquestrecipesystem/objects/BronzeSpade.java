...
public class BronzeSpade {
    ...
    public ItemStack getItemStack(int amount) {
        return conquestRecipes.itemstacks.createItemStack(amount, IRON_SHOVEL, "Bronze Spade", "A spade made of bronze. Used to dig.");
    }
    ...
    public void registerRecipe() {
        ...
        recipe3.setIngredient('I', new RecipeChoice.ExactChoice(conquestRecipes.itemstacks.getItemStack("BronzeIngot", 1)));
